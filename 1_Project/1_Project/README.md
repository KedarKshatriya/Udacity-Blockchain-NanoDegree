...
2. To make sure your application is working fine and it creates the Genesis Block you can use POSTMAN to request the Genesis block:
    ![Request: http://localhost:8000/block/0 ](ScreenShots/1_genesisBlock.png)
3. Make your first request of ownership sending your wallet address:
    ![Request: http://localhost:8000/requestValidation ](ScreenShots/2_requestValidation.png)
4. Sign the message with your Wallet:
    ![Use the Wallet to sign a message](ScreenShots/3_walletSign.png)
5. Submit your Star
     ![Request: http://localhost:8000/submitstar](ScreenShots/4_submitStar.png)
6. Retrieve Stars owned by me
    ![Request: http://localhost:8000/blocks/<WALLET_ADDRESS>](ScreenShots/5_starsOwnedByParticularAddress.png)
